...
public class Dependencies {
    ...
    public static Set<Artifact> getCoreExtensions(String runtimeVersion) {
        ...
        artifact = new DefaultArtifact(F3_GORUP_ID, "fabric3-java", "jar", runtimeVersion);
        extensions.add(artifact);

        artifact = new DefaultArtifact(F3_GORUP_ID, "fabric3-async", "jar", runtimeVersion);
        extensions.add(artifact);

        artifact = new DefaultArtifact(F3_GORUP_ID, "fabric3-sca-intents", "jar", runtimeVersion);
        extensions.add(artifact);

        artifact = new DefaultArtifact(F3_GORUP_ID, "fabric3-resource", "jar", runtimeVersion);
        extensions.add(artifact);
    ...
    public static Set<Artifact> getHostDependencies(String runtimeVersion) {
        ...
        Artifact fabric3Api = new DefaultArtifact(F3_GORUP_ID, "fabric3-api", "jar", runtimeVersion);
        ...
        // add Node API
        Artifact nodeAPI = new DefaultArtifact(F3_GORUP_ID, "fabric3-node-api", "jar", runtimeVersion);
        artifacts.add(nodeAPI);

        // add JUnit API
        Artifact junitAPI = new DefaultArtifact(F3_GORUP_ID, "fabric3-junit-api", "jar", runtimeVersion);
