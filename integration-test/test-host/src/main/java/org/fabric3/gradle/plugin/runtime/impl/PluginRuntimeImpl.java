...
import org.fabric3.gradle.plugin.api.contribution.PluginContributionSource;
...
public class PluginRuntimeImpl extends DefaultRuntime implements PluginRuntime<PluginHostInfo> {
    ...
    public PluginHostInfo getHostInfo() {
        return (PluginHostInfo) super.getHostInfo();
    }
